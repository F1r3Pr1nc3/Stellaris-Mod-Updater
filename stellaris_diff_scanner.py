...
old_version_folder = "d:\\GOG Games\\Settings\\Stellaris\\Stellaris4.1"
# old_version_folder = "d:\\GOG Games\\Settings\\Stellaris\\Stellaris3.14"
# new_version_folder = "d:\\GOG Games\\Settings\\Stellaris\\Stellaris4.1"
...
def compare_stellaris_data(old_path, new_path):
	...
	for cat, (pattern, subpath) in category_configs.items():
		...
		if cat in rename_chk_cats:
			...
			# if cat == "variables": # DEBUG
			# 	for k, i in new_blocks_all.items():
			# 		v, f = i
			# 		print(v)
